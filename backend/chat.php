...
<meta charset="UTF-8">
  ...
  <link rel="stylesheet" href="/client/static/css/chats.css" >
...
-->
            <div class="user-bar">
              <div class="back">
                <i onClick="goBack();" class="fa fa-arrow-left"></i>
			  </div>
              ...
              <div class="name">
            <a href="https://localhost/user?user=<? echo $_GET['uname']; ?> " >
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/moment-timezone/0.5.14/moment-timezone-with-data.min.js"></script>
 -->
 <script src="/client/static/js/chats.js"> </script>
